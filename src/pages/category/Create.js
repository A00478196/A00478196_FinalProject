    ...
    <>
       <Container>
            ...
            <form >
                ...
                <div className='my-4'>
                <Button text="Cancel" color="secondary" textColor="white"  className="me-3" onClick={()=>navigate('/category')}/>

                <Button text="Create" color="black" textColor="white" onClick={onSubmit}  disabled={loading}  />
